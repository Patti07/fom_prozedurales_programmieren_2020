...
public class ProzeduralesProgrammierenUebungsaufgabenMenuVorlesung4 {
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                Object[] options = {"Aufgabe9", "Aufgabe10_for_loop", "Aufgabe10_while_loop_kopf", "Aufgabe11_for_loop", "Aufgabe11_while_loop_kopf", "Aufgabe12_berechne_fakultaet", "Aufgabe13_summiere_fußgesteurtes_while", "Aufgabe13_summiere_kopfgesteurtes_while", "Aufgabe14_wuerfel_kopfgesteurtes_while", "Aufgabe15_wuerfel_produkt_summe_kopfgesteurtes_while", "Aufgabe16_iban_kopfgesteurtes_while", "Aufgabe17_groß_umgekehrte_Reihenfolge", "Aufgabe18_1x1_Matrix", "Aufgabe19_Schachbrett_Matrix"};
